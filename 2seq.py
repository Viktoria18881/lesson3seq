...
new_list = input('Введите любые цифры через запятую:').split(',')
numerical_series = [int(elem) for elem in new_list]

for elem in numerical_series:
    if numerical_series.count(elem) == 1:
